...
function connect() {
    function 
    let url = ["https://api.twitch.tv/kraken/videos/top?period=month&game=Overwatch",
        "https://api.twitch.tv/kraken/games/top?limit=1",
        "https://api.twitch.tv/kraken/streams/themexicanrunner"];
